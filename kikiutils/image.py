...
from .check import isbytes, response_is_ok
from .file import get_file_mime, save_file, save_file_as_bytesio
...
def get_image_dhash(image: _cv2.Mat | _numpy.ndarray, resize: bool = True):
    """Get image dhash."""
